  ...
  return (
    ...
    >
      ...
      <p>
        ...
        <span className="font-medium">web development</span>. After earning my
        Bachelor's degree, I found my passion in prgogramming. I started
        learning <span className="font-medium">front-end development</span>,
        through online platforms and BootCamps and quickly fell in love with it.
      ...
      <p>
        ...
        , I've also explored TypeScript & Next.js. I'm always learning and eager
        to take on new challenges. I am currently looking for a{" "}
